...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_100us/dark_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_100us/dark_index/logs
...
do
	...
	do
		if [ $irun == 118 ] || [ $irun == 119 ] || [ $irun == 120 ] || [ $irun == 121 ] || [ $irun == 122 ] || [ $irun == 123 ] || [ $irun == 124 ] || [ $irun == 125 ] || [ $irun == 126 ] || [ $irun == 127 ]|| [ $irun == 128 ] || [ $irun == 129 ] || [ $irun == 130 ] || [ $irun == 131 ] || [ $irun == 132 ] || [ $irun == 133 ] || [ $irun == 134 ] || [ $irun == 135 ] || [ $irun == 136 ] || [ $irun == 137 ] || [ $irun == 138 ];then
 			echo $irun
                        	for iacq in $RAWDATA/run0$irun/data/acq*.dark.lst;do
