...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_3ns/light_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_3ns/light_index/logs
...
do
	...
	do
		if [ $irun == 67 ] || [ $irun == 68 ] || [ $irun == 69 ] || [ $irun == 70 ] || [ $irun == 71 ] || [ $irun == 72 ] || [ $irun == 73 ] || [ $irun == 74 ] || [ $irun == 75 ] || [ $irun == 76 ] || [ $irun == 77 ] || [ $irun == 78 ] || [ $irun == 79 ] || [ $irun == 80 ]; then
 			echo $irun
