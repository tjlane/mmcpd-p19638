...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_1ns/dark_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_1ns/dark_index/logs
...
do
	...
	do
		if [ $irun == 147 ] || [ $irun == 148 ] || [ $irun == 149 ] || [ $irun == 150 ] || [ $irun == 151 ] || [ $irun == 152 ] || [ $irun == 153 ] || [ $irun == 154 ]; then
 			echo $irun
