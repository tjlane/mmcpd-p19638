...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_10us/light_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_10us/light_index/logs
...
do
	...
	do
		if [ $irun == 178 ] || [ $irun == 179 ] || [ $irun == 180 ] || [ $irun == 181 ] || [ $irun == 182 ] || [ $irun == 183 ] || [ $irun == 184 ];then
 			echo $irun
