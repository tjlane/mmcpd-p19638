...
### CONFIGURATION ###
PGROUP=/sf/alvra/data/p19638/work/tuning_param/indexed_frame_lst #Please modify the path #
SAMPLEFOLDER=/sf/alvra/data/p19638/ # this is the folder in which the data are stored
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_10ns/dark_index_v5/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_10ns/dark_index_v5/logs
...
do
        ...
        do
		if [ $irun == 34 ] || [ $irun == 35 ] || [ $irun == 36 ] || [ $irun == 37 ] || [ $irun == 38 ] || [ $irun == 39 ] || [ $irun == 43 ] || [ $irun == 44 ] || [ $irun == 45 ] || [ $irun == 46 ] || [ $irun == 47 ] || [ $irun == 48 ]; then
                echo $irun
