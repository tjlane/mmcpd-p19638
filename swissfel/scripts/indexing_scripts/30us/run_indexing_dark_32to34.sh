...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_30us/dark_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_30us/dark_index/logs
...
do
	...
	do
	#	if [ $irun == 111 ] || [ $irun == 112 ] || [ $irun == 113 ] || [ $irun == 114 ] || [ $irun == 115 ] || [ $irun == 116 ] || [ $irun == 117 ]; then
		if [ $irun == 115 ]; then
