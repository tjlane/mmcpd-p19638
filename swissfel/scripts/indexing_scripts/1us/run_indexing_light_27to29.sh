...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_1us/light_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_1us/light_index/logs
...
do
	...
	do
		if [ $irun == 94 ] || [ $irun == 95 ] || [ $irun == 96 ] || [ $irun == 97 ] || [ $irun == 98 ] || [ $irun == 99 ]; then
 			echo $irun
