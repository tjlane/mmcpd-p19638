...
SAVEFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_300ps/dark_index/streams
CONFFOLDER=/sf/alvra/data/p19638/work/tuning_param/geom_files
LOGFOLDER=/sf/alvra/data/p19638/work/tuning_param/indexing_300ps/dark_index/logs
...
do
	...
	do
		if [ $irun == 106 ] || [ $irun == 107 ] || [ $irun == 108 ] || [ $irun == 109 ] || [ $irun == 110 ]; then
 			echo $irun
